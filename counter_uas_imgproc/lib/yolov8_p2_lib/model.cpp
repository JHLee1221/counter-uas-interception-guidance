                                            ...
                                            int& max_channels)
{
  ...
  *******************************************************************************************************/
  ...
  // 11233
  nvinfer1::IElementWiseLayer* conv8 = C2F(network, weightMap, *conv7->getOutput(0), get_width(1024, gw, max_channels),
                                           get_width(1024, gw, max_channels), get_depth(3, gd), true, 0.5, "model.8");
  nvinfer1::IElementWiseLayer* conv9 = SPPF(network, weightMap, *conv8->getOutput(0), get_width(1024, gw, max_channels),
  ...
  *******************************************************************************************************/
  ...
  nvinfer1::IElementWiseLayer* conv12 = C2F(network, weightMap, *cat11->getOutput(0), get_width(512, gw, max_channels),
  ...
  nvinfer1::IElementWiseLayer* conv15 = C2F(network, weightMap, *cat14->getOutput(0), get_width(256, gw, max_channels),
  ...
  nvinfer1::IElementWiseLayer* conv18 = C2F(network, weightMap, *cat17->getOutput(0), get_width(512, gw, max_channels),
  ...
  *******************************************************************************************************/
  ...
  nvinfer1::IElementWiseLayer* conv22_cv3_0_1 =
      convBnSiLU(network, weightMap, *conv22_cv3_0_0->getOutput(0), base_out_channel, 3, 1, 1, "model.22.cv3.0.1");
  ...
  nvinfer1::IElementWiseLayer* conv22_cv3_1_1 =
      convBnSiLU(network, weightMap, *conv22_cv3_1_0->getOutput(0), base_out_channel, 3, 1, 1, "model.22.cv3.1.1");
  ...
  nvinfer1::IElementWiseLayer* conv22_cv3_2_1 =
      convBnSiLU(network, weightMap, *conv22_cv3_2_0->getOutput(0), base_out_channel, 3, 1, 1, "model.22.cv3.2.1");
  ...
  *******************************************************************************************************/
  ...
  nvinfer1::IShuffleLayer* dfl22_0 =
      DFL(network, weightMap, *split22_0_0->getOutput(0), 4, (kInputH / strides[0]) * (kInputW / strides[0]), 1, 1, 0,
  ...
  nvinfer1::IShuffleLayer* dfl22_1 =
      DFL(network, weightMap, *split22_1_0->getOutput(0), 4, (kInputH / strides[1]) * (kInputW / strides[1]), 1, 1, 0,
          "model.22.dfl.conv.weight");
  ...
  nvinfer1::IShuffleLayer* dfl22_2 =
      DFL(network, weightMap, *split22_2_0->getOutput(0), 4, (kInputH / strides[2]) * (kInputW / strides[2]), 1, 1, 0,
          "model.22.dfl.conv.weight");
  ...
  auto* calibrator =
      new Int8EntropyCalibrator2(1, kInputW, kInputH, kInputQuantizationFolder, "int8calib.table", kInputTensorName);
                                              ...
                                              int& max_channels)
{
  ...
  *******************************************************************************************************/
  ...
  nvinfer1::IElementWiseLayer* conv10 = C2F(network, weightMap, *conv9->getOutput(0), get_width(1024, gw, max_channels),
  ...
  *******************************************************************************************************/
  ...
  // P4/16-medium
  nvinfer1::IElementWiseLayer* conv21 =
      convBnSiLU(network, weightMap, *conv20->getOutput(0), get_width(256, gw, max_channels), 3, 2, 1, "model.21");
  ...
  nvinfer1::IElementWiseLayer* conv24 =
      convBnSiLU(network, weightMap, *conv23->getOutput(0), get_width(512, gw, max_channels), 3, 2, 1, "model.24");
  ...
  nvinfer1::IElementWiseLayer* conv27 =
      convBnSiLU(network, weightMap, *conv26->getOutput(0), get_width(768, gw, max_channels), 3, 2, 1, "model.27");
  ...
  *******************************************************************************************************/
  ...
  nvinfer1::IElementWiseLayer* conv30_cv3_0_1 =
      convBnSiLU(network, weightMap, *conv30_cv3_0_0->getOutput(0), base_out_channel, 3, 1, 1, "model.30.cv3.0.1");
  ...
  nvinfer1::IElementWiseLayer* conv30_cv3_1_1 =
      convBnSiLU(network, weightMap, *conv30_cv3_1_0->getOutput(0), base_out_channel, 3, 1, 1, "model.30.cv3.1.1");
  ...
  nvinfer1::IElementWiseLayer* conv30_cv3_2_1 =
      convBnSiLU(network, weightMap, *conv30_cv3_2_0->getOutput(0), base_out_channel, 3, 1, 1, "model.30.cv3.2.1");
  ...
  nvinfer1::IElementWiseLayer* conv30_cv3_3_1 =
      convBnSiLU(network, weightMap, *conv30_cv3_3_0->getOutput(0), base_out_channel, 3, 1, 1, "model.30.cv3.3.1");
  ...
  *******************************************************************************************************/
  ...
  nvinfer1::IShuffleLayer* dfl30_0 =
      DFL(network, weightMap, *split30_0_0->getOutput(0), 4, (kInputH / strides[0]) * (kInputW / strides[0]), 1, 1, 0,
          "model.30.dfl.conv.weight");
  ...
  nvinfer1::IShuffleLayer* dfl30_1 =
      DFL(network, weightMap, *split30_1_0->getOutput(0), 4, (kInputH / strides[1]) * (kInputW / strides[1]), 1, 1, 0,
          "model.30.dfl.conv.weight");
  ...
  nvinfer1::IShuffleLayer* dfl30_2 =
      DFL(network, weightMap, *split30_2_0->getOutput(0), 4, (kInputH / strides[2]) * (kInputW / strides[2]), 1, 1, 0,
          "model.30.dfl.conv.weight");
  ...
  nvinfer1::IShuffleLayer* dfl30_3 =
      DFL(network, weightMap, *split30_3_0->getOutput(0), 4, (kInputH / strides[3]) * (kInputW / strides[3]), 1, 1, 0,
          "model.30.dfl.conv.weight");
                                              ...
                                              int& max_channels)
{
  ...
  *******************************************************************************************************/
  ...
  nvinfer1::ITensor* concat11_inputs[] = {
    upsample10->getOutput(0), conv6->getOutput(0)
  };  // Assuming conv6 corresponds to "backbone P4" as per your pseudocode
  ...
  nvinfer1::IElementWiseLayer* conv19 =
      convBnSiLU(network, weightMap, *conv18->getOutput(0), get_width(128, gw, max_channels), 3, 2, 1, "model.19");
  nvinfer1::ITensor* concat20_inputs[] = {
    conv19->getOutput(0), conv15->getOutput(0)
  };  // concatenate with higher-resolution feature map from P3
  ...
  nvinfer1::IElementWiseLayer* conv22 =
      convBnSiLU(network, weightMap, *conv21->getOutput(0), get_width(256, gw, max_channels), 3, 2, 1, "model.22");
  nvinfer1::ITensor* concat23_inputs[] = {
    conv22->getOutput(0), conv12->getOutput(0)
  };  // concatenate with higher-resolution feature map from P4
  ...
  nvinfer1::IElementWiseLayer* conv25 =
      convBnSiLU(network, weightMap, *conv24->getOutput(0), get_width(512, gw, max_channels), 3, 2, 1, "model.25");
  nvinfer1::ITensor* concat26_inputs[] = {
    conv25->getOutput(0), conv9->getOutput(0)
  };  // concatenate with higher-resolution feature map from P5
  ...
  *******************************************************************************************************/
  ...
  nvinfer1::IElementWiseLayer* conv28_cv3_0_1 =
      convBnSiLU(network, weightMap, *conv28_cv3_0_0->getOutput(0), base_out_channel, 3, 1, 1, "model.28.cv3.0.1");
  ...
  nvinfer1::IElementWiseLayer* conv28_cv3_1_1 =
      convBnSiLU(network, weightMap, *conv28_cv3_1_0->getOutput(0), base_out_channel, 3, 1, 1, "model.28.cv3.1.1");
  ...
  nvinfer1::IElementWiseLayer* conv28_cv3_2_1 =
      convBnSiLU(network, weightMap, *conv28_cv3_2_0->getOutput(0), base_out_channel, 3, 1, 1, "model.28.cv3.2.1");
  ...
  nvinfer1::IElementWiseLayer* conv28_cv3_3_1 =
      convBnSiLU(network, weightMap, *conv28_cv3_3_0->getOutput(0), base_out_channel, 3, 1, 1, "model.28.cv3.3.1");
  ...
  *******************************************************************************************************/
  ...
  nvinfer1::IShuffleLayer* dfl28_0 =
      DFL(network, weightMap, *split28_0_0->getOutput(0), 4, (kInputH / strides[0]) * (kInputW / strides[0]), 1, 1, 0,
          "model.28.dfl.conv.weight");
  ...
  nvinfer1::IShuffleLayer* dfl28_1 =
      DFL(network, weightMap, *split28_1_0->getOutput(0), 4, (kInputH / strides[1]) * (kInputW / strides[1]), 1, 1, 0,
          "model.28.dfl.conv.weight");
  ...
  nvinfer1::IShuffleLayer* dfl28_2 =
      DFL(network, weightMap, *split28_2_0->getOutput(0), 4, (kInputH / strides[2]) * (kInputW / strides[2]), 1, 1, 0,
          "model.28.dfl.conv.weight");
  ...
  nvinfer1::IShuffleLayer* dfl28_3 =
      DFL(network, weightMap, *split28_3_0->getOutput(0), 4, (kInputH / strides[3]) * (kInputW / strides[3]), 1, 1, 0,
          "model.28.dfl.conv.weight");
                                            ...
                                            nvinfer1::DataType dt, const std::string& wts_path, float& gd, float& gw)
{
  ...
  assert(builder->platformHasFastInt8());
  config->setFlag(nvinfer1::BuilderFlag::kINT8);
  auto* calibrator = new Int8EntropyCalibrator2(1, kClsInputW, kClsInputH, kInputQuantizationFolder, "int8calib.table",
                                                kInputTensorName);
  config->setInt8Calibrator(calibrator);
#endif
